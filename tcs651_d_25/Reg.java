...
public class fbregistration {
  ...
  public void f() {
    ...
    driver.findElement(By.xpath("//*[@value='First Name']")).sendKeys("prachi");
    driver.findElement(By.xpath("//*[@value='Last Name']")).sendKeys("pundir");

    driver.findElement(By.id("u_0_5")).sendKeys("prachipundir1907@gmail.com");

    driver.findElement(By.id("u_0_8")).sendKeys("prachipundir1907@gmail.com");
    driver.findElement(By.id("u_0_a")).sendKeys("xyz12345");
    new org.openqa.selenium.support.ui.Select(driver.findElement(By.xpath("//*[@name='birthday_day']"))).selectByVisibleText("19");
